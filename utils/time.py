...
class ShortTime:
    compiled = re.compile("""(?:(?P<years>[0-9])(?:years?|an|ani|yrs|yr|y))?             # e.g. 2y
                             (?:(?P<months>[0-9]{1,2})(?:months?|luni|luna|lună|month|mo))?     # e.g. 2months
                             (?:(?P<weeks>[0-9]{1,4})(?:weeks?|săptămână|saptamana|săptămâni|saptamani|sapt|week|w))?        # e.g. 10w
                             (?:(?P<days>[0-9]{1,5})(?:days?|zi|zile|day|d))?          # e.g. 14d
                             (?:(?P<hours>[0-9]{1,5})(?:hours?|ore|ora|oră|hour|hrs|hr|h))?        # e.g. 12h
                             (?:(?P<minutes>[0-9]{1,5})(?:minutes?|minut|minute|minute|mins|min|m))?    # e.g. 10m
                             (?:(?P<seconds>[0-9]{1,5})(?:seconds?|secunde|secundă|second|secs|sec|s))?    # e.g. 15s
